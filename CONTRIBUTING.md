...
1. To begin, [fork this project], clone your fork, and add our upstream.
	...
	git clone https://github.com/<your-username>/react-calculator

	# Navigate to the newly cloned directory
	cd react-calculator

	# Assign the original repo to a remote called "upstream"
	git remote add upstream https://github.com/guuibayer/react-calculator

	# Install the tools necessary for development
	npm install

    # To development, run the project and go to localhost:8080 in you browser
    npm start
